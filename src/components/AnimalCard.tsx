...
export default class AnimalCard extends Component<IProps> {
  ...
  render() {
    const { animal, setAnimal } = this.props;
    ...
    return (
      ...
      >
        <div className="animal-type">{this.renderTypeIcon(type)}</div>
        ...
        <div className="lg-screen animal-reports">
          <span className="count">{reports?.length}</span>
        </div>
        <div className="lg-screen animal-created-at">
          <span className="time">{moment(created_at).fromNow()}</span>
        </div>
        <div className="lg-screen animal-buttons">
          <button
            type="button"
        ...
        <div className="sm-screen">
          <div className="animal-reports">
            <span className="count">Reports: {reports?.length}</span>
          </div>
