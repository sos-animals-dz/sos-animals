  ...
  return (
    <div className="privacy-policy">
      ...
      <div className="privacy-content">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to SOS Animals DZ, Algiers, Algeria.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Algeria
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to SOS Animals DZ, accessible from{' '}
              <a
                href="sos-animals.vercel.app"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                sos-animals.vercel.app
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: sos.animals.dz@gmail.com</li>
        </ul>
      </div>
    </div>
  );
